...
<head>
    ...
    <style>
        ...
        .main-content {
            ...
            flex: 1;
            padding: 3rem 4rem; /* Initial padding */
            min-height: 100vh;
            display: flex;
            justify-content: center; /* Helper to center the container */
        }
        
        /* Centered Wrapper */
        .main-container {
            width: 100%;
            max-width: 1200px; /* Constrain width to prevent "too much right" feel on wide screens */
            margin: 0 auto;
        }
